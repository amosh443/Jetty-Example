...
public class DBHelper {
    ...
    public static final String DB_HOST = "jdbc:mysql://localhost:3306/dbname?useUnicode=true&characterEncoding=UTF-8&autoreconnect=true";
    ...
    public void runQuery(Connection connection, String sql, ResultHandler resultHandler) throws SQLException {
        try (Statement statement = connection.createStatement();
